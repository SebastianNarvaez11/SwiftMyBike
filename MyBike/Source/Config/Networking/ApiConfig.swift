...
//    hay que comprobar si cuando se instalandesde yiendas si las leen, aqui no deben quedar variable quemadas
    ...
    static let baseUrlPlaspy: String = "https://www.plaspy.com/"
    static let userPlaspy: String = "sebastiannarvaez400@gmail.com"
    static let apiKeyPlaspy: String = "omTAyocSzKlK7EMNhV08blDDJ1G0RJOQ+TCIuwtMv5g="
}
